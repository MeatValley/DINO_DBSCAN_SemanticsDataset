...
def intra_distance(dico, perturb=False):
    ...
    for k in dico.keys():
        ...
        # print("SHAPE : ", np.stack(dico[k]).shape) #how many dino features for same patch (2,3,4,5)
...
def tsne_plot(points_features, N_labels, dist=None, labels=None, perplexity=10, #perplexity was 30 -> 4
              n_components=2):
    """Plot the t-SNE embedding of the points_features.
        t-SNE is a representation of multidimensional vectors in 2D by
    
    """
    print('[in TSNE plotting...]')
